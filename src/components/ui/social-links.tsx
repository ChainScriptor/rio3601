...
export const SocialLinks: React.FC<SocialLinksProps> = ({
    ...
    return (
        <>
            {/* ===== Desktop View ===== */}
            <div
                className={`${showOnMobile ? "hidden lg:flex" : "hidden md:flex"
                            ...
                            >
                             ...
                             bg-[hsl(var(--card))] shadow-md hover:shadow-lg"
                                >
                                    {/* Gradient Overlay */}
                                    <div
                                        className={`absolute inset-0 bg-gradient-to-r ${hoveredPlatform === platform
                                            ? style.hoverGradient
                                            : style.gradient
            ...
            {showOnMobile && (
                <div className="lg:hidden fixed bottom-28 right-6 z-40">
                    ...
                    <div className="relative">
                        {/* Floating Icons */}
                        <div
                            className={`absolute bottom-20 right-0 flex flex-col-reverse gap-3 transition-all duration-500 ${mobileDockOpen
